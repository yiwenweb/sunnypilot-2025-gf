...
class Panda:
  ...
  H7_DEVICES = [HW_TYPE_RED_PANDA, HW_TYPE_TRES, HW_TYPE_CUATRO, HW_TYPE_RED_PANDA_V2]
  SUPPORTED_DEVICES = H7_DEVICES

  INTERNAL_DEVICES = (HW_TYPE_TRES, HW_TYPE_CUATRO, HW_TYPE_RED_PANDA_V2)
